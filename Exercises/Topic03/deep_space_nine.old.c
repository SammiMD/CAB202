...
/*
double accel(double dx, double dy) {
    int x = dx - 5.0,
        y = dy - 5.0;
    static double accelerationTable[11][6]={
        ...
        {0.22,	0.22, 0.21, 0.21, 0.20, 0.20},
        {0.22,	0.21, 0.21, 0.20, 0.20, 0.19},
...
void setup(void) {
    ...
    station = sprite_create((x_star - 9), (y_star - 6), 1, 1, DS9);
...
void accelerate_station_towards_star(void) {
    ...
    if(dist_squared < 1.0e-10) {
        dist_squared = 1.0e-10;
    }
