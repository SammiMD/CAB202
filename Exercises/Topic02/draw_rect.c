...
void draw_rect(void) {
    ...
    /*
    draw_line(l, t, cols, t, symbol);
    draw_line(l, rows, cols, rows, symbol);
    draw_line(l, t, l, rows, symbol);
    draw_line(cols, t, cols, rows, symbol);
    */
   /*
    draw_line(l, t, l+cols, t, symbol);
    draw_line(l+cols, t, l+cols, t+rows, symbol);
    draw_line(l+cols, t+rows, l, t+rows, symbol);
    draw_line(l, t+rows, l, t, symbol);
    */
}
